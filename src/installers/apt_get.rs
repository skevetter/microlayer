...
/// Install packages using apt-get with minimal layer footprint
pub fn install(
    packages: &[String],
    ppas: Option<&[String]>,
...
fn add_ppas(ppas: &[String]) -> Result<(Vec<String>, Vec<String>)> {
    ...
    // Normalize PPAs to have ppa: prefix
    ...
    // Determine required PPA support packages
    ...
    // Install PPA support packages if needed
